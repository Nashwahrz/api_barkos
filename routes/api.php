...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/products/{product}/chats/{user}/status', [ChatController::class, 'chatStatus']);
    Route::post('/products/{product}/chats/{user}/close', [ChatController::class, 'closeChat']);
